...
class DrawingClassifier:
    ...
    def init_gui(self):
        ...
        self.root = Tk()
        self.root.title(f"Drawing Classifier v0.2 - {self.proj_name}")
    ...
    def save_everything(self):
        ...
        with open(f"{self.proj_name}/{self.proj_name}_data.pickle", "wb") as f:
            pickle.dump(data, f)
        tkinter.messagebox.showinfo("drawDrawing Classifier", "Project successfully saved!", parent=self.root)
